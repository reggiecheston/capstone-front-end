  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://sql5.freemysqlhosting.net/updatedTickets",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <div onSubmit={handleSubmit}>
      <ul className="collapsible expandable">
        <li>
          ...
          <div
            className="collapsible-body black-text blue-grey lighten-4"
            id="ticketBody"
          >
            <h5 className="center-align" type="text" placeholder={props?.title}>
              {props.title}
            </h5>
            <div onSubmit={handleSubmit}>
              <p
              ...
              <p id="datelineTop" className="center">
                Due Date: 3/4/24
              </p>

              <div>
                <p id="datelineBottom" className="center">
                  Issuing Staff: Bill Smith
                </p>
              </div>
